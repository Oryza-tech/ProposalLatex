...
\begin{enumerate}
    \item Merancang, mensimulasikan, dan menguji algoritma pemrograman kinematika gerak berorde tiga untuk menggenerasikan profil pergerakan \textit{rectangular, trapezoidal}, dan \textit{S-Curve} secara bergantian pada unit pemroses mikrokontroler \textit{dual-core} secara \textit{real-time}.
